...
export default {
	...
	gz_jin_zhangchunhua: new Character({
		...
		maxHp: 3,
		hujia: 0,
		skills: bool ? ["gzhuishi", "fakeqingleng"] : ["gz_ejue", "gz_shangshi"],
		hasSkinInGuozhan: bool ? null : true,
	}),
	gz_jin_simayi: new Character({
		...
		maxHp: bool ? 3 : 4,
		hujia: 0,
		skills: bool ? ["fakequanbian", "smyyingshi", "fakezhouting"] : ["gz_yingshi", "gz_shunfu"],
		hasSkinInGuozhan: bool ? null : true,
	}),

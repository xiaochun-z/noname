const translates = {
	...
	cuilingyi: "崔令仪",
	dchuashang: "华裳",
	dchuashang_info: "①游戏开始时,将每种颜色各一张牌置入你的装备区。②你使用一张牌结算完毕后，你可将一张相同花色的非装备手牌置入你的装备区。③当你的手牌数少于X，你将手牌数补至X（X为你装备区的花色数）。",
	dcyuzhi: "逾制",
	...
	x_dc_zhangqiying: "新杀张琪瑛",
	x_dc_zhangqiying_prefix: "新杀",
	x_dc_falu: "法箓",
	...
	dczhendu: "酖毒",
	dczhendu_info: "出牌阶段结束时，你可以展示至多五张基本或普通锦囊牌，然后你的下个回合开始时视为依次使用这些牌（无距离限制）。你使用这些牌期间有角色回复体力或受到伤害后，你摸一张牌（因此获得的牌不计入本回合手牌上限）。",
	v_machao: "威马超",
	v_machao_prefix: "威",
	dczhongtao: "众讨",
	dczhongtao_info: "出牌阶段限一次，你可以选择至多X+1种花色（X为你已损失的体力值），然后随机获得弃牌堆中你选择花色的各一张牌。本回合你使用过三种类别的牌后，此技能本阶段改为“出牌阶段限两次”。",
	dcjizhan: "极斩",
	dcjizhan_info: "连招技（坐骑或防具牌+黑色牌）你选择一项：1.弃置至多X名角色各一张牌；2.对一名角色造成X点伤害，然后此技能本回合失效（X为本回合〖极斩〗的发动次数）。",
};

const translates = {
	...
	x_dc_zhenyi: "真仪",
	x_dc_zhenyi_info: "一名角色于其回合内使用首张非装备牌时，你可以移去一个记录的花色并选择一项：♥，此牌目标+1/-1；♦：此牌造成伤害+1/-1；♠：本回合其使用此花色的牌时摸一张牌或其不能使用此花色的牌；♣：此牌额外结算一次或无效。",
	x_dc_dianhua: "点化",
	x_dc_dianhua_info: "准备阶段或结束阶段，你可以观看牌堆顶四张牌，然后获得其中一张花色已记录的牌，将其余牌以任意顺序放回牌堆顶。",

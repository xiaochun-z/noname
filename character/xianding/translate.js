const translates = {
	...
	dcminshan: "愍善",
	dcminshan_info: "当你受到1点伤害后，你可令一名角色从牌堆中获得两张与此伤害牌相同花色的牌（若〖育贤〗存在记录花色，则改为获得〖育贤〗记录花色的牌）。",
	zhanghuai: "张怀",
	get dclaoyan() {
	...
	dcchuanyu: "传舆",
	dcchuanyu_tag: "舆",
	dcchuanyu_info: "①每轮开始时，你可摸一张牌然后交给一名角色一张牌，称为「舆」。②每当「舆」因使用进入弃牌堆时，你可将其交给本轮未获得过「舆」的一名角色。③每轮结束时，你可令本轮所有获得过「舆」的角色依次视为对你指定的一名角色使用【杀】(不限距离），然后弃置所有「舆」。",
	dcyitou: "倚投",
	dcyitou_info: "其他角色的出牌阶段开始时，若其手牌数为全场最多，你可将所有手牌交给该角色，直到你的下回合开始，该角色造成伤害后，你摸1张牌。",
};

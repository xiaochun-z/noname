const translates = {
	...
	xia_caopi_prefix: "侠",
	peqinyi: "勤艺",
	peqinyi_info: "每回合当你首次造成或受到伤害后，你可以视为使用一张未以此法使用过的基本牌或普通锦囊牌。",
	pejixin: "技新",
	pejixin_info: "当你使用牌后，若你本局游戏未使用过相同牌名的牌（本次除外），你可以摸X张牌并展示之，令这些牌不计距离次数和手牌上限（X为此技能本轮发动次数）。",
	pejiwei: "继魏",
	pejiwei_info: "觉醒技，每个回合结束时，若本轮“技新”发动次数不小于1号位的当前体力值，你增加1点体力上限并回复所有体力且你可从武将牌堆中任选5个魏势力主公技获得。",
	eu_kaisa: "欧陆凯撒",
	eu_kaisa_prefix: "欧陆",
	eu_ducai: "独裁",
	...
	shefujing_fu: "伏",
	shefujing_fu_info: "你每回合首次造成/受到伤害后，令你获得此标记的角色可以：1.摸一张牌；2.获得1点护甲；3.&poptip=背水&，失去1点体力并对你发动一次〖攻心〗。",
	shefujiang: "浮江",
	...
	hm_juedian: "决巅",
	hm_juedian_info: "锁定技。当你每回合首次使用目标唯一的牌造成伤害后，你选择一项并视为对受伤角色使用一张【决斗】：①失去1点体力。②减1点体力上限。③&poptip=背水&：你令此牌的伤害值基数+1。",
	hm_nitian: "逆天",
	...
	peaoyong: "鏊勇",
	peaoyong_info: "持恒技，你不因此技能获得牌时，可以选择一项：1.摸一张牌；2.回复1点体力；3.使用一张牌；&poptip=背水&，减少1点体力上限。",
	petongkai: "同忾",

const translates = {
	...
	yjjiechu: "劫出",
	yjjiechu_info: "转换技，阳：出牌阶段，你可以视为使用一张【顺手牵羊】，结算结束后成为目标的角色可以对你使你一张【杀】；阴：当你成为【杀】的目标时，你可以弃置一张手牌改变【杀】的花色和属性。",
	yjdaojue: "道抉",
	...
	yjqingzheng: "清正",
	yjqingzheng_info: "出魏阶段开始时，你可以展示所有手牌并弃置其中一种花色的所有牌，然后展示一名其他角色的所有手牌井弃置其中一种花色的所有牌，若你以此法被弃置的牌数大于其以此法被弃置的牌数，你对其造成1点伤害。",
	yjzhian: "冶暗",
	yjzhian_info: "每回合限X次，当一名角色使用的非基本牌结算结束后，你可以选择一项：①弃置一张手牌，获得场上或弃牌堆中的此牌；②回复1点体力，此技能本轮失效；③对其造成X点伤害，然后你获得技能〖飞影〗井删去此选项(X为你已损失体力值且至少为1)。",
};

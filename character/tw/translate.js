const translates = {
	...
	tw_fuwan_prefix: "TW",
	twmoukui: "谋溃",
	twmoukui_info: "当你使用【杀】指定目标后，你可以选择一项：①摸一张牌；②弃置该角色的一张牌；③&poptip=背水&：若此【杀】未因造成伤害而令该角色进入过濒死状态，则该角色弃置你的一张牌。",
	tw_yujin: "SP于禁",
	tw_yujin_prefix: "SP",
	xinzhenjun: "镇军",
	...
	twyuanhu: "援护",
	twyuanhu_info: "①游戏开始时，你获得〖决助〗。②出牌阶段限一次。你可将一张装备牌置入一名角色的装备区内。若此牌为：武器牌，你弃置与其距离为1的另一名角色区域的一张牌；防具牌，其摸一张牌；坐骑牌，其回复1点体力；宝物牌，你选择基本牌或普通锦囊牌从牌堆中获得一张，其获得另一类型的一张牌。然后若其体力值或手牌数不大于你，则你可摸一张牌，且你可以于本回合结束时发动一次〖援护〗。",
	twjuezhu: "决助",
	...
	twyimou: "毅谋",
	twyimou_info: "当与你距离1以内的其他角色受到伤害后，你可以选择一项：1.令其从牌堆中获得一张【杀】；2.令其将一张手牌交给另一名角色并摸两张牌；3.&poptip=背水&：依次执行上述所有选项，然后将所有手牌交给其。",
	tw_liufuren: "刘夫人",
	twzhuidu: "追妒",
	twzhuidu_info: "出牌阶段限一次。你可以选择一名已受伤的其他角色并选择一项：1.对其造成1点伤害；2.弃置其装备区里的一张牌；3.&poptip=背水&：依次执行上述所有选项，然后若该角色为女性，弃置一张牌。",
	twshigong: "示恭",
	...
	twyilie: "毅烈",
	twyilie_info: "出牌阶段开始时，你可以选择一项：1.本阶段内使用【杀】的次数上限+1；2.本回合内使用【杀】指定处于连环状态的目标后，或使用【杀】被【闪】抵消时，摸一张牌；3.&poptip=背水&：依次执行上述所有选项，然后失去1点体力。",
	tw_chendong: "TW陈武董袭",
	tw_chendong_prefix: "TW",
	twfenming: "奋命",
	twfenming_info: "准备阶段，你可以选择一名其他角色并选择一项：1.令其弃置一张牌；2.令其横置；3.&poptip=背水&：依次执行上述所有选项，然后横置。",
	tw_handang: "TW韩当",
	...
	twliechi: "烈斥",
	twliechi_info: "当你受到伤害后，若伤害来源的体力值不小于你，你可以选择一项：1.令其将手牌数弃置至与你的手牌数相同；2.弃置其一张牌；3.&poptip=背水&：若你本回合进入过濒死状态，依次执行上述所有选项，然后弃置一张装备牌。",
	tw_yl_luzhi: "TW卢植",
	...
	tw_zongyu_prefix: "TW",
	twzhibian: "直辩",
	twzhibian_info: "出牌阶段开始时，你可以与一名其他角色拼点。若你赢，你可以选择一项：{1.将其区域里的一张牌移动到你的对应区域；2.回复1点体力；3.&poptip=背水&：依次执行上述所有选项，然后弃置一张非基本牌}；若你没赢，你失去1点体力。",
	twyuyan: "御严",
	...
	xia_guanyu_prefix: "侠",
	twzhongyi: "忠义",
	twzhongyi_info: "锁定技。①你使用【杀】无距离限制。②当你使用【杀】结算完毕后，你选择一项：⒈摸X张牌；⒉回复X点体力；⒊&poptip=背水&：依次执行以上两项，然后失去Y点体力（X为受到此牌造成的伤害的角色数，Y为你本局游戏选择此项的次数）。",
	twchue: "除恶",
